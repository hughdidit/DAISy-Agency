...
>>>>>>> 2011edc9e (fix(gateway): preserve agentId through gateway send path):apps/shared/OpenClawKit/Sources/OpenClawProtocol/GatewayModels.swift
...
public struct SkillsBinsParams: Codable, Sendable {}
>>>>>>> 9e1a13bf4 (Gateway/UI: data-driven agents tools catalog with provenance (openclaw#24199) thanks @Takhoffman):apps/shared/OpenClawKit/Sources/OpenClawProtocol/GatewayModels.swift
...
=======
        ...
        twophase: Bool?)
    {
>>>>>>> f53e4e9ff (chore: Fix broken build protocol:check):apps/shared/OpenClawKit/Sources/OpenClawProtocol/GatewayModels.swift
        self.id = id
        self.command = command
