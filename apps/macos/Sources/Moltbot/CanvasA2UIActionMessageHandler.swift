import AppKit
import Foundation
<<<<<<< HEAD:apps/macos/Sources/Moltbot/CanvasA2UIActionMessageHandler.swift
import MoltbotIPC
import MoltbotKit
=======
import OpenClawIPC
import OpenClawKit
>>>>>>> 8725c2b19 (style(swift): run swiftformat + swiftlint autocorrect):apps/macos/Sources/OpenClaw/CanvasA2UIActionMessageHandler.swift
import WebKit
