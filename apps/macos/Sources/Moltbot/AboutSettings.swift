...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/moltai/openclawbot") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/moltai/openclawbot")
    ...
    private var buildTimestamp: String? {
        guard let raw = Bundle.main.object(forInfoDictionaryKey: "OpenClawBuildTimestamp") as? String
        else { return nil }
