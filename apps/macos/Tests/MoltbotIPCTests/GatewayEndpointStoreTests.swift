...
<<<<<<< HEAD:apps/macos/Tests/MoltbotIPCTests/GatewayEndpointStoreTests.swift
...
>>>>>>> 774d73b45 (fix(macos): reject insecure non-loopback ws remote gateway urls (#21971)):apps/macos/Tests/OpenClawIPCTests/GatewayEndpointStoreTests.swift
