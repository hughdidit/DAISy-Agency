import Foundation
<<<<<<< HEAD:apps/macos/Tests/MoltbotIPCTests/GatewayConnectionControlTests.swift
import MoltbotKit
=======
import OpenClawKit
>>>>>>> 7b3f506e6 (style(swift): apply swiftformat and swiftlint fixes):apps/macos/Tests/OpenClawIPCTests/GatewayConnectionControlTests.swift
import Testing
