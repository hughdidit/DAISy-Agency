...
# TRELLO_API_KEY and TRELLO_TOKEN are optional (trello integration)
...
unset OPENCLAW_GATEWAY_TOKEN CLAUDE_AI_SESSION_KEY DISCORD_BOT_TOKEN ANTHROPIC_API_KEY MONGODB_URI GEMINI_API_KEY CLAUDE_WEB_SESSION_KEY CLAUDE_WEB_COOKIE BRAVE_API_KEY FIRECRAWL_API_KEY GOOGLE_WORKSPACE_CLI_TOKEN TRELLO_API_KEY TRELLO_TOKEN GWS_CREDENTIALS_B64
