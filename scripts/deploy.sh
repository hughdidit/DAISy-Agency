...
read -r KANBAN_MONGODB_DATABASE || KANBAN_MONGODB_DATABASE=""
KANBAN_MONGODB_DATABASE="${KANBAN_MONGODB_DATABASE:-daisy_kanban}"
read -r KANBAN_BOARD_SLUG || KANBAN_BOARD_SLUG=""
KANBAN_BOARD_SLUG="${KANBAN_BOARD_SLUG:-team-agents}"
read -r KANBAN_BOARD_TITLE || KANBAN_BOARD_TITLE=""
KANBAN_BOARD_TITLE="${KANBAN_BOARD_TITLE:-Team Agents}"
...
# Export app environment for docker compose
