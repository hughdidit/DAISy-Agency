...
read -r FINN_DISCORD_BOT_TOKEN || FINN_DISCORD_BOT_TOKEN=""
read -r KODY_DISCORD_BOT_TOKEN || KODY_DISCORD_BOT_TOKEN=""
read -r ART_DISCORD_BOT_TOKEN || ART_DISCORD_BOT_TOKEN=""
...
export FINN_DISCORD_BOT_TOKEN
export KODY_DISCORD_BOT_TOKEN
export ART_DISCORD_BOT_TOKEN
...
unset OPENCLAW_GATEWAY_TOKEN DISCORD_BOT_TOKEN FINN_DISCORD_BOT_TOKEN KODY_DISCORD_BOT_TOKEN ART_DISCORD_BOT_TOKEN ANTHROPIC_API_KEY OPENAI_API_KEY MONGODB_URI GEMINI_API_KEY BRAVE_API_KEY FIRECRAWL_API_KEY TRELLO_API_KEY TRELLO_TOKEN GOOGLE_WORKSPACE_CLI_TOKEN GWS_CREDENTIALS_B64 DAISY_ENVIRONMENT
...
# Pass all secrets via stdin (one per line)
{
  ...
  --tunnel-through-iap \
  --quiet \
  --command "bash -lc ${REMOTE_COMMAND_ESCAPED}"
