...
POST_DEPLOY_SESSION_REFRESH_HEALTH_TIMEOUT_SECONDS="${11:-90}"
...
POST_DEPLOY_SESSION_REFRESH_HEALTH_TIMEOUT_SECONDS="${POST_DEPLOY_SESSION_REFRESH_HEALTH_TIMEOUT_SECONDS:-90}"
...
printf -v SESSION_REFRESH_HEALTH_TIMEOUT_ESCAPED '%q' "${POST_DEPLOY_SESSION_REFRESH_HEALTH_TIMEOUT_SECONDS:-90}"
