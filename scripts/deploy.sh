...
read -r SALLY_DISCORD_BOT_TOKEN || SALLY_DISCORD_BOT_TOKEN=""
...
export SALLY_DISCORD_BOT_TOKEN
...
unset OPENCLAW_GATEWAY_TOKEN DISCORD_BOT_TOKEN FINN_DISCORD_BOT_TOKEN \
  KODY_DISCORD_BOT_TOKEN ART_DISCORD_BOT_TOKEN SALLY_DISCORD_BOT_TOKEN \
  ANTHROPIC_API_KEY OPENAI_API_KEY MONGODB_URI GEMINI_API_KEY \
