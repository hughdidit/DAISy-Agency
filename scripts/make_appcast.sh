...
FEED_URL=${2:-"https://raw.githubusercontent.com/moltai/openclawbot/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/moltai/openclawbot/releases/download/v${VERSION}/"}
