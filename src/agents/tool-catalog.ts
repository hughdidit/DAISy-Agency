...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    id: "kanban_read",
    label: "kanban_read",
    description: "Read Kanban board/cards/activity",
    sectionId: "kanban",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "kanban_write",
    label: "kanban_write",
    description: "Mutate Kanban cards",
    sectionId: "kanban",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "kanban_pick_task",
    label: "kanban_pick_task",
    description: "Claim next Codex-ready card",
    sectionId: "kanban",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "kanban_handoff",
    label: "kanban_handoff",
    description: "Move card to Review",
    sectionId: "kanban",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  ...
  },
  {
    id: "ocr_extract",
    label: "ocr_extract",
    description: "Local OCR extraction",
    sectionId: "media",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
