...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['openclaw agents set-identity --agent main --name "Clawd" --emoji "🦞"', "Set name + emoji."],
  ["openclaw agents set-identity --agent main --avatar avatars/clawd.png", "Set avatar path."],
  ["openclaw agents set-identity --workspace ~/clawd --from-identity", "Load from IDENTITY.md."],
  [
    "openclaw agents set-identity --identity-file ~/clawd/IDENTITY.md --agent main",
