...
export const SUPPORTED_SANDBOX_RUNTIME_PROFILES = [
  ...
  },
  {
    ...
    expectedBinaries: ["node", "npm", "git", "bash", "zip", "unzip"],
  ...
  },
  {
    ...
    expectedBinaries: ["node", "npm", "git", "bash", "python3", "uv", "zip", "unzip"],
  ...
  },
  {
    ...
    expectedBinaries: ["node", "npm", "git", "bash", "chrome", "zip", "unzip"],
