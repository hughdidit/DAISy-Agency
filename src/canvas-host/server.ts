...
(() => {
  ...
  const legacySend = typeof window.openclawSendUserAction === "function" ? window.openclawSendUserAction : undefined;
  if (!window.openclawSendUserAction && legacySend) {
    window.openclawSendUserAction = legacySend;
  }
  if (!window.openclawSendUserAction && typeof window.openclawSendUserAction === "function") {
    window.openclawSendUserAction = window.openclawSendUserAction;
  }
  const hasHelper = () =>
