...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.imageGeneration.enabled": "Enable Image Generation Tool",
  "tools.imageGeneration.defaultProvider": "Image Generation Default Provider",
  "tools.imageGeneration.google": "Google Image Generation",
  "tools.imageGeneration.google.model": "Google Image Generation Model",
  "tools.imageGeneration.google.timeoutSeconds": "Google Image Generation Timeout (sec)",
  "tools.imageGeneration.google.maxInputImages": "Google Image Generation Max Input Images",
  "tools.imageGeneration.google.maxResponseBytes": "Google Image Generation Max Response Bytes",
  "tools.imageGeneration.comfyui": "ComfyUI Image Generation",
  "tools.imageGeneration.comfyui.baseUrl": "ComfyUI Base URL",
  "tools.imageGeneration.comfyui.defaultPreset": "ComfyUI Default Preset",
  "tools.imageGeneration.comfyui.timeoutSeconds": "ComfyUI Timeout (sec)",
  "tools.imageGeneration.comfyui.pollIntervalMs": "ComfyUI Poll Interval (ms)",
  "tools.imageGeneration.comfyui.allowRemote": "Allow Remote ComfyUI Targets",
  "tools.imageGeneration.comfyui.allowedHostnames": "ComfyUI Allowed Hostnames",
  "tools.imageGeneration.comfyui.maxRequestBytes": "ComfyUI Max Request Bytes",
  "tools.imageGeneration.comfyui.maxResponseBytes": "ComfyUI Max Response Bytes",
  "tools.imageGeneration.comfyui.presets": "ComfyUI Presets",
  "tools.imageGeneration.comfyui.presets.*.description": "ComfyUI Preset Description",
  "tools.imageGeneration.comfyui.presets.*.workflow": "ComfyUI Preset Workflow",
  "tools.imageGeneration.comfyui.presets.*.inputs": "ComfyUI Preset Input Mapping",
  "tools.imageGeneration.comfyui.presets.*.inputs.prompt": "ComfyUI Prompt Input Mapping",
  "tools.imageGeneration.comfyui.presets.*.inputs.negativePrompt":
    "ComfyUI Negative Prompt Mapping",
  "tools.imageGeneration.comfyui.presets.*.inputs.seed": "ComfyUI Seed Mapping",
  "tools.imageGeneration.comfyui.presets.*.inputs.steps": "ComfyUI Steps Mapping",
  "tools.imageGeneration.comfyui.presets.*.inputs.cfgScale": "ComfyUI CFG Scale Mapping",
  "tools.imageGeneration.comfyui.presets.*.inputs.width": "ComfyUI Width Mapping",
  "tools.imageGeneration.comfyui.presets.*.inputs.height": "ComfyUI Height Mapping",
  "tools.imageGeneration.comfyui.presets.*.inputs.sampler": "ComfyUI Sampler Mapping",
  "tools.imageGeneration.comfyui.presets.*.inputs.scheduler": "ComfyUI Scheduler Mapping",
  "tools.imageGeneration.comfyui.presets.*.inputs.*.nodeId": "ComfyUI Mapped Node ID",
  "tools.imageGeneration.comfyui.presets.*.inputs.*.inputName": "ComfyUI Mapped Input Name",
  "tools.imageGeneration.comfyui.presets.*.output": "ComfyUI Preset Output Selection",
  "tools.imageGeneration.comfyui.presets.*.output.nodeId": "ComfyUI Output Node ID",
  "tools.imageGeneration.comfyui.presets.*.output.imageIndex": "ComfyUI Output Image Index",
  ...
  "gateway.controlUi.hideAgentFileExchangeWhenGoogleDriveEnabled":
    "Hide File Manager When Google Drive Is Enabled",
  ...
  kanban: "Kanban",
  "kanban.enabled": "Kanban Enabled",
  "kanban.mongodb": "Kanban MongoDB",
  "kanban.mongodb.uri": "Kanban MongoDB URI",
  "kanban.mongodb.database": "Kanban MongoDB Database",
  "kanban.mongodb.collections": "Kanban MongoDB Collections",
  "kanban.mongodb.collections.boards": "Kanban Boards Collection",
  "kanban.mongodb.collections.cards": "Kanban Cards Collection",
  "kanban.mongodb.collections.activity": "Kanban Activity Collection",
  "kanban.mongodb.collections.imports": "Kanban Imports Collection",
  "kanban.mongodb.collections.attachments": "Kanban Attachments Collection",
  "kanban.mongodb.collections.gridFsBucket": "Kanban Attachments GridFS Bucket",
  "kanban.board": "Kanban Board",
  "kanban.board.slug": "Kanban Board Slug",
  "kanban.board.title": "Kanban Board Title",
  "kanban.notifications": "Kanban Notifications",
  "kanban.notifications.reviewReady": "Kanban Review Ready Notifications",
  ...
  "agents.defaults.spendBudget": "Spend Budget",
  "agents.defaults.spendBudget.enabled": "Enable Spend Budget",
  "agents.defaults.spendBudget.currency": "Budget Currency",
  "agents.defaults.spendBudget.monthlyLimitUsd": "Monthly Limit (USD)",
  "agents.defaults.spendBudget.timezone": "Budget Timezone",
  "agents.defaults.spendBudget.warnAtUsd": "Budget Warn Threshold (USD)",
  "agents.defaults.spendBudget.degradeAtUsd": "Budget Degrade Threshold (USD)",
  "agents.defaults.spendBudget.hardStopAtUsd": "Budget Hard Stop Threshold (USD)",
  "agents.defaults.spendBudget.ownerEmergencyReserveUsd": "Owner Emergency Reserve (USD)",
  "agents.defaults.spendBudget.maxProjectedCostPerAttemptUsd": "Max Cost Per Attempt (USD)",
  "agents.defaults.spendBudget.maxProjectedCostPerRunUsd": "Max Cost Per Run (USD)",
  "agents.defaults.spendBudget.blockMessage": "Budget Block Message",
  ...
  "agents.defaults.sandbox.profile": "Sandbox Runtime Profile",
  ...
  "agents.list[].sandbox.profile": "Agent Sandbox Runtime Profile",
