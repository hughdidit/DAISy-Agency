...
describe("config schema", () => {
  ...
  it("exports schema + hints", () => {
    ...
    expect(
      res.uiHints["gateway.controlUi.hideAgentFileExchangeWhenGoogleDriveEnabled"]?.label,
    ).toContain("Google Drive");
    expect(
      res.uiHints["gateway.controlUi.hideAgentFileExchangeWhenGoogleDriveEnabled"]?.help,
