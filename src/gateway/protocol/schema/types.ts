...
export type AgentsWorkspaceFileEntry = SchemaType<"AgentsWorkspaceFileEntry">;
export type AgentsWorkspaceFileDocument = SchemaType<"AgentsWorkspaceFileDocument">;
export type AgentsWorkspaceFilesListParams = SchemaType<"AgentsWorkspaceFilesListParams">;
export type AgentsWorkspaceFilesListResult = SchemaType<"AgentsWorkspaceFilesListResult">;
export type AgentsWorkspaceFilesGetParams = SchemaType<"AgentsWorkspaceFilesGetParams">;
export type AgentsWorkspaceFilesGetResult = SchemaType<"AgentsWorkspaceFilesGetResult">;
export type AgentsWorkspaceFilesSetParams = SchemaType<"AgentsWorkspaceFilesSetParams">;
export type AgentsWorkspaceFilesSetResult = SchemaType<"AgentsWorkspaceFilesSetResult">;
export type AgentsWorkspaceFilesDeleteParams = SchemaType<"AgentsWorkspaceFilesDeleteParams">;
export type AgentsWorkspaceFilesDeleteResult = SchemaType<"AgentsWorkspaceFilesDeleteResult">;
export type AgentsWorkspaceFilesMkdirParams = SchemaType<"AgentsWorkspaceFilesMkdirParams">;
export type AgentsWorkspaceFilesMkdirResult = SchemaType<"AgentsWorkspaceFilesMkdirResult">;
export type AgentsWorkspaceFilesMoveParams = SchemaType<"AgentsWorkspaceFilesMoveParams">;
export type AgentsWorkspaceFilesMoveResult = SchemaType<"AgentsWorkspaceFilesMoveResult">;
...
export type ResolvedCapabilityClass = SchemaType<"ResolvedCapabilityClass">;
export type ResolvedCapabilityKind = SchemaType<"ResolvedCapabilityKind">;
export type ResolvedCapabilityDenyReason = SchemaType<"ResolvedCapabilityDenyReason">;
export type ResolvedCapabilityUnavailableReason = SchemaType<"ResolvedCapabilityUnavailableReason">;
export type ResolvedCapabilityRuntimeContext = SchemaType<"ResolvedCapabilityRuntimeContext">;
export type ResolvedCapabilityPolicySource = SchemaType<"ResolvedCapabilityPolicySource">;
export type ResolvedCapabilityPolicy = SchemaType<"ResolvedCapabilityPolicy">;
export type ResolvedCapabilityRuntimeEvidence = SchemaType<"ResolvedCapabilityRuntimeEvidence">;
export type ResolvedCapabilityProjectionEvidence =
  SchemaType<"ResolvedCapabilityProjectionEvidence">;
export type ResolvedCapabilityProviderEvidence = SchemaType<"ResolvedCapabilityProviderEvidence">;
export type ResolvedCapabilityRemoteEvidence = SchemaType<"ResolvedCapabilityRemoteEvidence">;
export type ResolvedCapabilityEvidence = SchemaType<"ResolvedCapabilityEvidence">;
export type SkillStatusRequirements = SchemaType<"SkillStatusRequirements">;
export type SkillStatusConfigCheck = SchemaType<"SkillStatusConfigCheck">;
export type SkillInstallOption = SchemaType<"SkillInstallOption">;
export type SkillRemoteSatisfied = SchemaType<"SkillRemoteSatisfied">;
export type ResolvedSkillLocalCapability = SchemaType<"ResolvedSkillLocalCapability">;
export type ResolvedSkillRemoteCapability = SchemaType<"ResolvedSkillRemoteCapability">;
export type ResolvedSkillBlockedCapability = SchemaType<"ResolvedSkillBlockedCapability">;
export type ResolvedSkillUnsupportedCapability = SchemaType<"ResolvedSkillUnsupportedCapability">;
export type ResolvedSkillCapability = SchemaType<"ResolvedSkillCapability">;
export type ResolvedToolLocalCapability = SchemaType<"ResolvedToolLocalCapability">;
export type ResolvedToolBrokeredCapability = SchemaType<"ResolvedToolBrokeredCapability">;
export type ResolvedToolRemoteCapability = SchemaType<"ResolvedToolRemoteCapability">;
export type ResolvedToolBlockedCapability = SchemaType<"ResolvedToolBlockedCapability">;
export type ResolvedToolUnsupportedCapability = SchemaType<"ResolvedToolUnsupportedCapability">;
export type ResolvedToolCapability = SchemaType<"ResolvedToolCapability">;
export type ResolvedCapabilityManifest = SchemaType<"ResolvedCapabilityManifest">;
export type SkillStatusEntry = SchemaType<"SkillStatusEntry">;
export type SkillsStatusParams = SchemaType<"SkillsStatusParams">;
export type SkillsStatusResult = SchemaType<"SkillsStatusResult">;
...
export type KanbanActor = SchemaType<"KanbanActor">;
export type KanbanBoard = SchemaType<"KanbanBoard">;
export type KanbanCard = SchemaType<"KanbanCard">;
export type KanbanActivity = SchemaType<"KanbanActivity">;
export type KanbanCardMutationResult = SchemaType<"KanbanCardMutationResult">;
export type KanbanStatusParams = SchemaType<"KanbanStatusParams">;
export type KanbanStatusResult = SchemaType<"KanbanStatusResult">;
export type KanbanBoardGetParams = SchemaType<"KanbanBoardGetParams">;
export type KanbanBoardGetResult = SchemaType<"KanbanBoardGetResult">;
export type KanbanCardsListParams = SchemaType<"KanbanCardsListParams">;
export type KanbanCardsListResult = SchemaType<"KanbanCardsListResult">;
export type KanbanCardsGetParams = SchemaType<"KanbanCardsGetParams">;
export type KanbanCardsGetResult = SchemaType<"KanbanCardsGetResult">;
export type KanbanCardsCreateParams = SchemaType<"KanbanCardsCreateParams">;
export type KanbanCardsUpdateParams = SchemaType<"KanbanCardsUpdateParams">;
export type KanbanCardsMoveParams = SchemaType<"KanbanCardsMoveParams">;
export type KanbanCardsCommentParams = SchemaType<"KanbanCardsCommentParams">;
export type KanbanCardsAttachmentAddParams = SchemaType<"KanbanCardsAttachmentAddParams">;
export type KanbanCardsAttachmentArchiveParams = SchemaType<"KanbanCardsAttachmentArchiveParams">;
export type KanbanCardsArchiveParams = SchemaType<"KanbanCardsArchiveParams">;
export type KanbanActivityListParams = SchemaType<"KanbanActivityListParams">;
export type KanbanActivityListResult = SchemaType<"KanbanActivityListResult">;
export type KanbanImportTrelloPreviewParams = SchemaType<"KanbanImportTrelloPreviewParams">;
export type KanbanImportTrelloPreviewResult = SchemaType<"KanbanImportTrelloPreviewResult">;
export type KanbanImportTrelloRunParams = SchemaType<"KanbanImportTrelloRunParams">;
export type KanbanImportTrelloRunResult = SchemaType<"KanbanImportTrelloRunResult">;
export type KanbanAgentPickNextParams = SchemaType<"KanbanAgentPickNextParams">;
export type KanbanAgentPickNextResult = SchemaType<"KanbanAgentPickNextResult">;
export type KanbanAgentHandoffParams = SchemaType<"KanbanAgentHandoffParams">;
export type KanbanAgentCompleteParams = SchemaType<"KanbanAgentCompleteParams">;
export type KanbanCodexPickNextParams = SchemaType<"KanbanCodexPickNextParams">;
export type KanbanCodexPickNextResult = SchemaType<"KanbanCodexPickNextResult">;
export type KanbanCodexHandoffParams = SchemaType<"KanbanCodexHandoffParams">;
export type KanbanCodexCompleteParams = SchemaType<"KanbanCodexCompleteParams">;
