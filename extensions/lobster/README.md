...
## Using `clawd.invoke` (Lobster → OpenClaw tools)

Some Lobster pipelines may include a `clawd.invoke` step to call back into OpenClaw tools/plugins (for example: `gog` for Google Workspace, `gh` for GitHub, `message.send`, etc.).
