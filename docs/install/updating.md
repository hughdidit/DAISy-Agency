...
- Snapshot your tailoring:
  - Config: `~/.clawdai/openclawbot.json`
...
Notes:
- `pnpm build` matters when you run the packaged `openclaw` binary ([`openclaw.mjs`](https://github.com/moltai/openclawbot/blob/main/openclaw.mjs)) or use Node to run `dist/`.
