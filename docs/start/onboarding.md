...
- Local onboarding now writes sandbox-first defaults for new configs (`agents.defaults.sandbox.mode: "all"`, `scope: "session"`, `profile: "coding-base"`). Existing explicit host compatibility settings are preserved.
