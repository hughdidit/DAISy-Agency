...
Inspect the **effective** sandbox mode/scope/workspace access, sandbox tool policy, and elevated gates (with fix-it config key paths). Use `--json` to also view the resolved sandbox and browser image fields.
