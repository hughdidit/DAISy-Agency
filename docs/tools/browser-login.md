...
OpenClaw controls a **dedicated Chrome profile** (named `daisy`, orange‑tinted UI). This is separate from your daily browser profile.
...
```bash
openclaw browser open https://x.com --browser-profile daisy --target host
```
