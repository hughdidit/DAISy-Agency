...
2) Configure WhatsApp in `~/.clawdai/openclawbot.json`.
...
**Can multiple people use different OpenClaws on one WhatsApp number?**  
...
- Log file: `/tmp/moltai/openclawbot-YYYY-MM-DD.log` (configurable).
