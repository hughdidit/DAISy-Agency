...
You can override this in `~/.clawdai/openclawbot.json`:
...
All logging configuration lives under `logging` in `~/.clawdai/openclawbot.json`.

```json
{
  "logging": {
    "level": "info",
    "file": "/tmp/moltai/openclawbot-YYYY-MM-DD.log",
    "consoleLevel": "info",
    "consoleStyle": "pretty",
