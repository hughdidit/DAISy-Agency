...
export const en: TranslationMap = {
  ...
  kanban: {
    ...
    import: {
      title: "Trello Import",
      subtitle: "JSON or CSV export",
      format: "Format",
      json: "JSON",
      csv: "CSV",
      file: "File",
      content: "Content",
      contentPlaceholder: "Paste Trello export content",
      preview: "Preview",
      run: "Run import",
      working: "Working...",
      previewTitle: "Preview",
      previewMeta: "{count} cards, {warnings} warnings",
      cardCounts: "{checklist} checklist, {comments} comments, {attachments} files",
